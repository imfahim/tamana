<footer class="sticky-footer">
  <div class="container">
    <div class="text-center">
      <small>Copyright &copy; Tamana Panel <script>document.write(new Date().getFullYear())</script></small>
    </div>
  </div>
</footer>
...
<script src="{{asset('panel/js/sb-admin-datatables.min.js')}}"></script>
<script src="{{asset('panel/js/sb-admin-charts.min.js')}}"></script>
</div>
</body>
